...
export const NotificationIconWithBadge: React.FC<{ count?: number }> = ({ count }) => {
  return (
    <Badge
      badgeContent={count}
      color="error"
...
// サイドバー項目の基本構造を定義
export const getListItems = (unreadCount?: number) => [
  { id: 1, icon: <Assignment />, label: 'OSINT', href: '/top' },
  {
    id: 2,
    icon: <NotificationIconWithBadge count={unreadCount} />,
    label: 'Notifications',
    href: '/notifications',
  },
  {
  ...
  // { id: 3, icon: <Settings />, label: 'Settings', href: '/settings' },
]
